...
import img10 from '../images/unimap.png';
import img11 from '../images/bus.jpg';
import img12 from '../images/teacher.png';
import img13 from '../images/canteen.png';
        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-blue-900 uppercase font-bold">Наши услуги</h2>
                        
                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-blue-900'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">Простая навигация для Вашего удобства</h2>
                    </div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img10} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Расположение и карта этажей</h2>
                                    <p className="text-md font-medium">
                                    Чтобы узнать свое местоположение и просмотреть карту университетского этажа, отсканируйте QR-код.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img11} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Ближайшая автобусная станция
</h2>
                                    <p className="text-md font-medium">
                                    Найдите ближайшую автобусную станцию к вашему текущему местоположению.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-2xl text-center "> Информация о преподавателе
</h2>
                                    <p className="text-md font-medium">
                                    Узнайте, кто из преподавателей находятся в университете, и часы их работы.
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img13} />
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Удобства поблизости
</h2>
                                    <p className="text-md font-medium">
                                    Легко находите близлежащие столовые, кафетерии и многое другое.
                                    </p>
                                </div>
                            </div>                    
                        </div>
