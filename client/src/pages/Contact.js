            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">Есть вопросы?</h1>
                        </div>
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">г.Тараз, ул.Толе би 60</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <div className="flex flex-col">
                        <h2 className="text-2xl">Позвоните Нам</h2>
                        <p className="text-gray-400">Тел: 8075384406</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Отправить электронное письмо</h2>
                                <p className="text-gray-400">dulaty@mail.ru</p>
                            </div>
